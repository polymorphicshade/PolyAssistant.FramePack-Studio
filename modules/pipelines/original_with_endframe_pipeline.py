...
class OriginalWithEndframePipeline(BasePipeline):
    ...
    def create_metadata(self, job_params, job_id):
        """
        Create metadata for the Original with Endframe generation.
        ...
        # Create a placeholder image for the Original with Endframe model
        height = job_params.get('height', 640)
        width = job_params.get('width', 640)
        placeholder_img = Image.new('RGB', (width, height), (128, 0, 128))  # Purple for Original with Endframe
